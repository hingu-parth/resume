...
const HomePage = () => {
  ...
  return (
    ...
    {/* <!-- Page --> */}
    <div className="p-6 mx-auto page max-w-2xl print:max-w-letter md:max-w-letter md:h-executive xsm:p-8 sm:p-9 md:p-16 print:mt-16 print:bg-white bg-gray-100 text-left">
